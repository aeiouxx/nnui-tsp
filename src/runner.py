...
def main():
    ...
    iterations = 375
    print(f"Running with seed {seed} for {iterations} iterations with {city_count} cities...")
    network = HopfieldNetwork(distances.copy(), cities, seed=seed, log_level=logging.DEBUG)
    result = network.run(iterations)
    ...
    print(f"Running with seed {seed} with {city_count} cities...")
